        ...
        <div className="max-w-7xl mx-auto w-full">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              {/* Subheadline */}
              <p className="text-xl md:text-2xl font-montserrat font-light text-gray-300 mb-8 leading-relaxed max-w-xl mx-auto lg:mx-0">
              ...
              <div className="flex justify-center lg:justify-start mb-8">
                <a
                  ...
                  className="inline-flex items-center gap-2 text-gray-400 hover:text-white transition-colors duration-200 font-montserrat text-sm"
                >
