...
export default function PricingSection() {
  return (
    <section id="pricing" className="relative py-24 px-4 bg-gradient-to-b from-black via-purple-950/20 to-black">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl font-montserrat text-gray-400 max-w-2xl mx-auto">
        ...
        >
          <div className="relative p-8 md:p-12 rounded-3xl bg-gradient-to-br from-gray-900 to-gray-900/50 border border-gray-800 shadow-2xl">
            {/* Beta Badge */}
            ...
            <div className="text-center mb-8 mt-4">
              ...
              <div className="flex items-baseline justify-center gap-2 mb-2">
                <span className="text-5xl md:text-6xl font-cormorant font-bold text-white">
                  FREE
                </span>
              </div>
              <div className="flex items-center justify-center gap-2 text-gray-400 font-montserrat">
            ...
            <p className="text-center text-sm text-gray-500 font-montserrat mt-6">
        ...
        <motion.p
          ...
          className="text-center text-gray-500 font-montserrat text-sm mt-12 max-w-2xl mx-auto"
        >
